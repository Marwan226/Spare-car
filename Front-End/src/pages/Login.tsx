      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 border-2 border-gray-200 focus:border-blue-500 transition-all"
                  required
                  disabled={loading}
                />
              </div>
            ...
            <Button
              type="submit"
              className="w-full h-12  transition-all shadow-lg hover:shadow-xl"
              disabled={loading}>
              {loading ? (
            ...
            <div className="grid grid-cols-3 gap-3">
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border-2 border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all">
